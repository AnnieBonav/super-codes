...
# This takes the parameters enterd by the user and creates another list (within the matrix) that has all the names, but now converted with the parameters entered.
def createNickname(peopleList):
    # I ask the user to tell me which list he wants to modify
    print('Would you like to look in besties or enemies?')
    chooseList = validateNumber()
